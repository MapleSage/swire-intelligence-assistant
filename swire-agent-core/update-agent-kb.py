...
def create_wind_energy_knowledge():
    """Create comprehensive wind energy knowledge for Swire agent"""
...
"""
    ...
    with open('wind_energy_knowledge.md', 'w') as f:
        f.write(knowledge_content)
    
    print("✅ Wind energy knowledge base created")
    print("📄 File: wind_energy_knowledge.md")
    
    return knowledge_content

def update_agent_instructions():
    """Update agent with wind energy expertise"""
...
Provide detailed, technical responses for wind energy professionals while being accessible to those new to the industry.""",
    ...
    with open('agent_wind_energy_config.json', 'w') as f:
        json.dump(agent_update, f, indent=2)
    
    print("✅ Agent configuration updated with wind energy expertise")
    
    return agent_update

if __name__ == "__main__":
    print("🌪️ Updating Swire Agent with Wind Energy Knowledge")
    
    # Create knowledge base
    knowledge = create_wind_energy_knowledge()
    
    # Update agent configuration
    config = update_agent_instructions()
    
    print("\n🚀 Ready to enhance Swire Intelligence Assistant with wind energy expertise!")
    print("📋 Next steps:")
    print("   1. Upload knowledge to Azure Cognitive Search")
    print("   2. Update Bedrock agent configuration")
    print("   3. Test wind energy queries")