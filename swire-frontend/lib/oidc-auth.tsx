...
const cognitoAuthConfig = {
  ...
  redirect_uri: typeof window !== 'undefined' ? window.location.origin : "https://sagegreen.vercel.app",
  response_type: "code",
...
export const useOIDCAuth = () => {
  ...
  const signOutRedirect = () => {
    ...
    const logoutUri = "https://sagegreen.vercel.app";
    const cognitoDomain = "https://sagegreen-auth.auth.us-east-1.amazoncognito.com";
